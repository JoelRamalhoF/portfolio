...
async function getAboutGithub() {
    ...
    try {
        const resposta = await fetch('https://api.github.com/users/JoelRamalhoF')
...
async function getProjectsGithub() {
    ...
    try {
        ...
        const resposta = await fetch('https://api.github.com/users/JoelRamalhoF/repos?sort=update&per_page=6')
